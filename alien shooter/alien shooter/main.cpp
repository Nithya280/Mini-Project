...
void introScreen()
{
    glClear(GL_COLOR_BUFFER_BIT);
        ...
        glColor3f(1.0, 0.0, 0.0);
    displayRasterText(-425, 490, 0.0,"BMS INSTITUTE OF TECHNOLOGY");
    ...
    displayRasterText(-100, 150, 0.0,"created by");
     ...
     displayRasterText(-130, 80, 0.0,"SHOOTERS");
      ...
      displayRasterText(-800, -100, 0.0," STUDENT NAMES");
          ...
          glColor3f(1.0, 1.0, 1.0);
    displayRasterText(-800, -200, 0.0," M Hithyshi");
...
void instructionsScreenDisplay()
{
    ...
    displayRasterText(-1100 ,-100 ,0.4 ,"Key 'x' to shoot, Use 'w' and 's' to change direction.");
    displayRasterText(100 ,-100 ,0.4 ,"Key 'n' to shoot, Use 'i' and 'k' to change direction.");
